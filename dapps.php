...
<section class="header7 cid-qZG3fBdJla mbr-fullscreen" id="dapps">
    ...
    <div class="container">
        <div class="media-container-row">
            ...
            <div class="media-content pt-md" data-aos="fade-right" data-aos-duration="1000">
                <span class="qoute float-left">"</span>
                <h1 class="mbr-section-title pb-3 mbr-bold mbr-fonts-style display-1 text-white">
                   Deploy pre-built <br> Dapps with a few <br> clicks
                </h1>
                <span class="bar mb-4" style="margin-left: 4.2rem"></span>
                <p class="text-white">Assets in digital form</p>
